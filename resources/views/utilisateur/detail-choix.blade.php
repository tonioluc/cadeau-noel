...
<div class="max-w-5xl mx-auto py-8">
    ...
    <div class="bg-vert-clair rounded-xl p-6 shadow mb-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
    ...
    <div class="mt-6 flex gap-4">
        <a href="{{ route('utilisateur.historique-choix') }}" class="text-vert-foret hover:underline">← Retour à l'historique</a>
    </div>
</div>
@endsection
